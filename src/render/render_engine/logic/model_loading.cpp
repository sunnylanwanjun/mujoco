...
public:
    ...
    void* Init(int w, int h, void* win) override {
        appWidth = w;
        appHeight = h;
...
private:
    ...
    void createSurface() {
        auto surfaceRes = glfwCreateWindowSurface(instance, window, nullptr, &surface);
...
APPLICATION_REG(HelloTriangleApplication)